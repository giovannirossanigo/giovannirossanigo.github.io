...
<ol>
    <li> It is clearly pointed, since the representable functor $y(0):\C^{\op}\to\Spc$  is compactly supported. Indeed, if we fix $j\in\mb{Z}$, then for every integer $i>0$ we have that
    \[

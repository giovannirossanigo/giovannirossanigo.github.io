...
<div class="definition">
  ...
  <ol>
    ...
    <li>
      We define the <em>category of compactly supported functors $\CS(\C)$ of $\C$</em> as the full subcategory of $\Ind(\C)$
      spanned by those functors $E:\C^{\op}\to\Spc$ such that for every $j\in\Z$
      there exists an integer $i>0$ such that
      $\pi_0\Hom_{\PSh(C)}(\y(\susp^jM_i), E)=0$.
    </li>
    <li>
      We let $\S(\C)= \Li(\C)\cap \CS(\C)$.
    </li>
  </ol>
</div>

...
\begin{enumerate}
    ...
    Since $\yo:\mc{C}\to\Ind(\mc{C})$ commutes with colimits by [{% cite LurieHA %}, Proposition 5.3.5.14], we have that 
    \begin{align*}
